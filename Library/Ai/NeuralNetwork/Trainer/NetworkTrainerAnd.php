...
/**
 * Neural network trainer to train a network on the outcome of the AND of two
 * boolean values.
 * 
 * @version 1.0 Tuesday 24th January 2017
 * @author Tom Gray
 */
class NetworkTrainerAnd extends AbstractBinaryNetworkTrainer
{
    
    /**
     * Test the accuracy of a network at guessing the output of the AND of two
     * boolean values.
     * 
    ...
    /**
     * Train a network on the outcome of the AND of two boolean values.
     * 
     * @param NetworkInterface $network
