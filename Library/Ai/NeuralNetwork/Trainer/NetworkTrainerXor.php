...
/**
 * Neural network trainer to train a network on the outcome of the XOR of two
 * boolean values.
 * 
 * @version 1.0 Tuesday 24th January 2017
 * @author Tom Gray
 */
class NetworkTrainerXor extends AbstractBinaryNetworkTrainer
{
    
    /**
     * Test the accuracy of a network at guessing the output of the XOR of two
     * boolean values.
     * 
    ...
    /**
     * Train a network on the outcome of the XOR of two boolean values.
     * 
     * @param NetworkInterface $network
